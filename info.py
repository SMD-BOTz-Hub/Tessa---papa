...
BOT_TOKEN = environ.get('BOT_TOKEN', "6694528458:AAElxJ06pXgusFBAykq60cPsPnnzsUVg_AA")
...
URL = "https://smd-linkzx.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smd-linkzx.onrender.com/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'SMDBotz'))
MULTI_CLIENT = False
...
if HAS_SSL:
    URL = "https://smd-havocvairam.koyeb.app/".format(FQDN)
else:
    URL = "https://smd-havocvairam.koyeb.app/".format(FQDN)
